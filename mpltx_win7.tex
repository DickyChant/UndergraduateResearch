...
%\SetBgContents{...的实验报告} %Waterstamp to prevent copyings
...
\begin{figure}[htbp]
    \centering
    \subfloat[粒子多重数解关联]{\includegraphics[width=0.3\textwidth]{mult.png}}
    \subfloat[形状解关联]{\includegraphics[width=0.3\textwidth]{shape.png}}
    \subfloat[相角解关联]{\includegraphics[width=0.3\textwidth]{angle.png}}
...
%\bibliography{S037026931630747X}ß
